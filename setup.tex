...
\define[1]\nombre{\kerncharacters[-.07]\tfd\WORDS\bf{#1}\par}
...
draw subpath (0,porcentaje) of fullcircle scaled 50 rotated 90 xscaled -1 withpen pencircle scaled 4bp withcolor \MPcolor{dtext};
...
draw Z[1] -- Z[#1] withpen pencircle scaled 3bp withcolor \MPcolor{texto};
for i = 1 upto #1:
filldraw fullcircle scaled u shifted Z[i] withcolor \MPcolor{texto};
endfor;
\stopreusableMPgraphic
\startskillColumn\color[dtext]{#2}\skillColumn\rightaligned{\reuseMPgraphic{nivel:#1}}\stopskillColumn\vskip-20pt}
