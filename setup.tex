...
\setuplayout[textwidth=279mm,header=20mm,footer=20mm,bottomspace=20mm]
\setupbodyfont[mosk]}
...
\def\tituloinvoice#1{
\blank[7mm]\startdoscolumnas\rightaligned{\color[azulv]{\WORDS\kerncharacters[.15]{\bf \doifmode{invoice}{Cuenta de cobro}\doifmode{cotizar}{Cotización}}}}
\doscolumnas{\tfa{#1}}
\stopdoscolumnas\null\vfill}

\def\startlineainvoice{\doifmode{cotizar}{\startDosColumnas\startdoscolumnas\rightaligned{\phantom{.}}\doscolumnas\phantom{.}\stopdoscolumnas\DosColumnas
\startcolsInvoice\color[mtext]{\$/semana}\colsInvoice\color[mtext]{\sc subtotal}\stopcolsInvoice\stopDosColumnas}
...
\vskip-8mm\startDosColumnas\startdoscolumnas\rightaligned{\phantom{.}}\doscolumnas\phantom{.}\stopdoscolumnas\DosColumnas\thinrule\stopDosColumnas\blank[medium]}
