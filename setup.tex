...
\def\tituloinvoice#1{
\blank[7mm]\startdoscolumnas\rightaligned{\color[azulv]{\WORDS\kerncharacters[.15]{\bf \doifmode{factura}{Factura}\doifmode{cotizar}{Cotización}}}}\doscolumnas{\tfa{#1}}
\stopdoscolumnas\null\vfill}

\def\startlineainvoice{\startDosColumnas\startdoscolumnas\null\doscolumnas\null\stopdoscolumnas\DosColumnas
\doifmode{cotizar}{\startcolsInvoice\color[mtext]{\$/semana}\colsInvoice\color[mtext]{\tfx\WORDS subtotal}\stopcolsInvoice}\doifmode{factura}{\null}\stopDosColumnas\startDosColumnas\startdoscolumnas\null\doscolumnas\null\stopdoscolumnas\DosColumnas\doifmode{cotizar}{\thinrule}\doifmode{factura}{\null}\stopDosColumnas}
...
\doscolumnas\rightaligned{\bfb\color[azulv]{\kerncharacters[.15]\WORDS Total}}\par\stopdoscolumnas
...
Z[4] := (5.5u,0);
Z[5] := (  7u,0);
draw Z[1] -- Z[5] withpen pencircle scaled 3bp withcolor 1.05\MPcolor{ltext};
for i = 1 upto 5:
filldraw fullcircle scaled u shifted Z[i] withcolor 1.05\MPcolor{ltext};
filldraw fullcircle scaled .5u shifted Z[i] withcolor \MPcolor{fondo};
endfor;
...
\stopreusableMPgraphic
\startskillColumn\color[dtext]{#2}\skillColumn\rightaligned{\reuseMPgraphic{nivel:#1}}\stopskillColumn}
